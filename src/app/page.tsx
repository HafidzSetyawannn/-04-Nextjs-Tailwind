...
import image1 from '../../public/images/almet.png';
    ...
    <div className="mt-16 px-8 max-w-3xl mx-auto">
      <header className="text-center">
        ...
        <p className="mt-2 text-zinc-600 text-lg">
          Halo, saya Hafidz! Saya seorang pengembang web dengan latar belakang di Teknik Informatika dan ketertarikan dalam teknologi web.
        </p>
      </header>
      ...
      <section className="mt-8">
        ...
        <ul className="mt-4 space-y-3 text-zinc-600">
          ...
          <li>📌 Sedang mengerjakan proyek Reservasi Sport Center.</li>
        </ul>
      </section>
